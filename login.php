...
if( isset( $_POST['login'] )) {
    ...
    if (mysqli_num_rows($result) === 1 ) {
        ...
        if ($password === $data["password"]) {
            ...
            if ($data["puskesmas"] === "Gandapura") {
                header("Location: gandapura/index.php");
            } elseif ($data["puskesmas" ] === "Kotajuang") {
                header("location: kotajuang/index.php");
            exit;
            }
        }
    }
...
$judulHalaman->setJudul('Halaman Login');
...
<body class="bg-gradient-primary">
  ...
  <h3 class="text-light row justify-content-center font-weight-bolder">SISTEM MONITORING RUTINITAS IMUNISASI BAYI</h3>
  ...
  <div class="row justify-content-center">
    ...
    ?>
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            Akun <strong>berhasil didaftar</strong>
    ...
    <?php } elseif($_GET['pesan'] === 'bukan_admin') { ?>
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            Anda Bukan Admin!!!
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
